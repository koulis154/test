...
def index12():
    if request.method =="POST":
        ...
        if request.form.get("library") == "Library":
            ...
            session.clear()
            return redirect(url_for('login'))
            t = url_for('static', filename='/Users/macuser/Desktop/flask/template/static/images/PHOTO-2022-09-12-21-20-40/ 2.jpg')
            return render_template('gg.html',r = {'a':'a','b':'b','/Users/macuser/Desktop/flask/template/static/images/PHOTO-2022-09-12-21-20-40/ 2.jpg':t}) 
